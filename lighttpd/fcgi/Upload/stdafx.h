...
extern long LinuxCreateThread(pthread_attr_t* lpThreadAttributes, LPTHREAD_START_ROUTINE lpStartAddress, void* lpParameter);
#define CreateThread(lpThreadAttributes,dwStackSize,lpStartAddress,lpParameter,dwCreationFlags,lpThreadId) (void*)LinuxCreateThread(lpThreadAttributes, lpStartAddress, lpParameter);
