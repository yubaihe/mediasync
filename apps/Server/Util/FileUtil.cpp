...
// string CFileUtil::GetNewFileNamex(int iYear, string strFileName, string strPostFix)
// {
//     int iIndex = 0;
...
{
    printf("CFileUtil::GetNewFileName\n");
    strFileName = Server::CCommonUtil::StringSplit(strFileName, "_")[0];
    int iIndex = 0;
    do
    {
        string strFile("");
...
string CFileUtil::GetNewFileName(int iYear, long iPaiSheTimeSec, string strPostFix)
{
    printf("CFileUtil::GetNewFileName2\n");
    string strFileName = Server::CCommonUtil::StringFormat("%ld", iPaiSheTimeSec);
    int iIndex = 0;
    do
    {
        string strFile("");
