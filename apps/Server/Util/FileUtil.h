...
public:
    ...
    static string GetNewFileName(int iYear, long iPaiSheTimeSec, string strPostFix);
    // static string GetNewFileNamex(int iYear, string strFileName, string strPostFix);
